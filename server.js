...
const hbars = exphbars.create(); // according to the documentation, this creates a new environment for the handlebars framework to exist in, but we have no helpers to export in
...
app.use(express.static(path.join(__dirname, 'public'))); // serves out public static files when the initial url path is routed to
